...
async def health_predictor(
    request: Request,
    temperature1: float = Form(...),
    humidity1: float = Form(...),
    moisture1: float = Form(...),
    distance1: float = Form(...),
    temperature2: float = Form(...),
    humidity2: float = Form(...),
    moisture2: float = Form(...),
    distance2: float = Form(...),
    temperature3: float = Form(...),
    humidity3: float = Form(...),
    moisture3: float = Form(...),
    distance3: float = Form(...),
    temperature4: float = Form(...),
    humidity4: float = Form(...),
    moisture4: float = Form(...),
    distance4: float = Form(...),
    temperature5: float = Form(...),
    humidity5: float = Form(...),
    moisture5: float = Form(...),
    distance5: float = Form(...),
):
    # Construct DataFrame
    df = pd.DataFrame(
        {
